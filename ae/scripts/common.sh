...
FUSIONANNS_THREADS="${FUSIONANNS_THREADS:-128}"
...
FUSIONANNS_THREAD_LIST="${FUSIONANNS_THREAD_LIST:-1,2,4,8,16,32,64,128,256,512}"
FUSIONANNS_NPROBE_LIST="${FUSIONANNS_NPROBE_LIST:-256,512,1024}"
FUSIONANNS_RERANK_LIST="${FUSIONANNS_RERANK_LIST:-128,256}"
FUSIONANNS_IO_BACKEND="${FUSIONANNS_IO_BACKEND:-io_uring}"
FUSIONANNS_QUERIES="${FUSIONANNS_QUERIES:-10000}"
FUSIONANNS_WARMUP="${FUSIONANNS_WARMUP:-0}"
# Keep FusionANNS comparable with the other systems: no host-side page cache
# by default. Set FUSIONANNS_CACHE_MB explicitly to enable it for a diagnostic run.
FUSIONANNS_CACHE_MB="${FUSIONANNS_CACHE_MB:-0}"

# Figure 6 diagnostic sweeps, selected from the cache=0 Pareto measurements.
# Keep these family-specific so SIFT and DEEP can evolve independently.
FUSIONANNS_SIFT_THREADS="${FUSIONANNS_SIFT_THREADS:-128}"
FUSIONANNS_SIFT_THREAD_LIST="${FUSIONANNS_SIFT_THREAD_LIST:-4,16,64,128,256}"
FUSIONANNS_SIFT_NPROBE_LIST="${FUSIONANNS_SIFT_NPROBE_LIST:-256,512,1024}"
FUSIONANNS_SIFT_RERANK_LIST="${FUSIONANNS_SIFT_RERANK_LIST:-128,256}"
FUSIONANNS_DEEP_THREADS="${FUSIONANNS_DEEP_THREADS:-128}"
FUSIONANNS_DEEP_THREAD_LIST="${FUSIONANNS_DEEP_THREAD_LIST:-1,4,16,32,128,256,512}"
FUSIONANNS_DEEP_NPROBE_LIST="${FUSIONANNS_DEEP_NPROBE_LIST:-256,512,1024}"
FUSIONANNS_DEEP_RERANK_LIST="${FUSIONANNS_DEEP_RERANK_LIST:-128,256}"
